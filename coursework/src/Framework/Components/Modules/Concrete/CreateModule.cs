...
internal sealed class CreateModule : Module
{
    ...
    internal override sealed void CompleteTask()
    {
        ...
        SystemLoggerService.Instance.AppendLogEntry(this, "LOG", "TRACE", $"[{base.Identifier}] sends [{newTask}] to the [{nextModule?.Identifier}]");
    }
    ...
    {
        SystemLoggerService.Instance.AppendLogEntry(this, "REPORT", "STATS", $"[{base.Identifier}]: Tasks: {this.CreatedTasksCount}");
